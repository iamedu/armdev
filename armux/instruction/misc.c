...
void clz_inst(int inst, ARMProc *proc) {
}

void swp_inst(int inst, ARMProc *proc) {
}

void swpb_inst(int inst, ARMProc *proc) {
}

void mrs_inst(int inst, ARMProc *proc) {
}

void msr_inst(int inst, ARMProc *proc) {
}

void msri_inst(int inst, ARMProc *proc) {
}
