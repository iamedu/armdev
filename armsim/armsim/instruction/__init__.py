...
#Coprocessor instructions
provideUtility(coprocessor.ARMCDPInstruction(), IARMInstruction, 'cdp')
provideUtility(coprocessor.ARMMRRCInstruction(), IARMInstruction, 'mrrc')
provideUtility(coprocessor.ARMLDCInstruction(), IARMInstruction, 'ldc')
provideUtility(coprocessor.ARMMCRInstruction(), IARMInstruction, 'mcr')
provideUtility(coprocessor.ARMMCRRInstruction(), IARMInstruction, 'mcrr')
provideUtility(coprocessor.ARMMRCInstruction(), IARMInstruction, 'mrc')
provideUtility(coprocessor.ARMSTCInstruction(), IARMInstruction, 'stc')
